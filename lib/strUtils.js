...
(function (module) {
    ...
    utils.extend(strUtils, {
            ...
            // Cut
            /**
             * Cut from the position by indexOf snippet in str
             *
             * @param {String} str
             * @param {String} snippet
             * @returns {String} indexSubString
             */
            cut: function (str, snippet) {
                var index = str.indexOf(snippet);
                if (index == -1) {
                    return null;
                }
            ...
            /**
             * Cut from the position by lastIndexOf snippet in str
             *
             * @param {String} str
             * @param {String} snippet
             * @returns {String} lastIndexSubString
             */
            lastCut: function (str, snippet) {
                var lastIndex = str.lastIndexOf(snippet);
                if (lastIndex == -1) {
                    return null;
                }
